...
#define SET_CS_LOW	HAL_GPIO_WritePin(LCD_CS_GPIO_Port, LCD_CS_Pin, GPIO_PIN_RESET)
#define SET_CS_HIGH	HAL_GPIO_WritePin(LCD_CS_GPIO_Port, LCD_CS_Pin, GPIO_PIN_SET)
#define SET_RST_LOW	HAL_GPIO_WritePin(LCD_RST_GPIO_Port, LCD_RST_Pin, GPIO_PIN_RESET)
#define SET_RST_HIGH	HAL_GPIO_WritePin(LCD_RST_GPIO_Port, LCD_RST_Pin, GPIO_PIN_SET)
#define SET_DC_LOW	HAL_GPIO_WritePin(LCD_DC_GPIO_Port, LCD_DC_Pin, GPIO_PIN_RESET)
#define SET_DC_HIGH	HAL_GPIO_WritePin(LCD_DC_GPIO_Port, LCD_DC_Pin, GPIO_PIN_SET)
...
void spiWrite(uint8_t c)
{
	...
	SET_CS_LOW;
	HAL_SPI_Transmit(&hspi1, &c, 1, 0xF);
	SET_CS_HIGH;
}
...
void LcdInit(void)
{
	/**> SPI already Initialized by STM32 CubeMx */
